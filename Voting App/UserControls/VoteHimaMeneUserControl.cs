...
{
    public partial class VoteHimaMeneUserControl : UserControl
    {
        public VoteForm Mainform { get; set; }
        public VoteHimaMeneUserControl(VoteForm mainform)
        {
            InitializeComponent();

            nrpCalon1Label.Text = AppHelper.CalonDBObj.CalonHimaMene1.NRP;
            namaCalon1Label.Text = AppHelper.CalonDBObj.CalonHimaMene1.Nama;

            nrpCalon2Label.Text = AppHelper.CalonDBObj.CalonHimaMene2.NRP;
            namaCalon2Label.Text = AppHelper.CalonDBObj.CalonHimaMene2.Nama;

            nrpCalon3Label.Text = AppHelper.CalonDBObj.CalonHimaMene3.NRP;
            namaCalon3Label.Text = AppHelper.CalonDBObj.CalonHimaMene3.Nama;

            calon1RadioButton.Text = AppHelper.CalonDBObj.CalonHimaMene1.Nama;
            calon2RadioButton.Text = AppHelper.CalonDBObj.CalonHimaMene2.Nama;
            calon3RadioButton.Text = AppHelper.CalonDBObj.CalonHimaMene3.Nama;
